...
public class quiz {
    ...
    /*Constructor for the quiz class. This creates a new instance of a quiz given the amount of questions a user wants
     */
    ...
    /* boolean methods used to check if the users answer matches with the answer, not case-sensitive (this is how it works from correct1 all the way to correct4)
    */
    ...
    /* void method with no parameters, when called it prints out the questions and incorporates the boolean methods correct1 through correct4 in order to check
    if the user input is correct. After the user completes the quiz it prints out the amount of questions the user got right out of the number they answered
    ...
    /*
    toString method modified to print out the answer key for the quiz
     */
